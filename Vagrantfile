# Configures Ubuntu 14.04 VM to be used with Deex 2.0 (Graphene)
...
if [ ! -d "graphene" ]; then
  echo_msg "building deex graphene toolkit.."  
...
Vagrant.configure(2) do |config|
  ...
  config.vm.provider :aws do |aws, override|
    ...
    aws.security_groups = [ 'deexxt' ]
    override.vm.hostname = 'deexxt-aws'
