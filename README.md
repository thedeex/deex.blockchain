...
**Build Script:**
    ...
    git clone https://github.com/thedeex/deex.blockchain.git
    cd deex.blockchain
...
**Upgrade Script** (prepend to the Build Script above if you built a prior release):
    ...
    git remote set-url origin https://github.com/thedeex/deex.blockchain.git
    git checkout master
...
**NOTE:** Deex requires a [Boost](http://www.boost.org/) version in the range [1.57 - 1.65.1]. Versions earlier than
...
**NOTE:** Deex requires a 64-bit operating system to build, and will not build on a 32-bit OS.

**NOTE:** Deex now supports Ubuntu 18.04 LTS

**NOTE:** Deex now supports OpenSSL 1.1.0
...
quired memory is growing fast. Consider the following table as minimal requirements before running a node:
